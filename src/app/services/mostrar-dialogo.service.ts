...
private colorField = (key: string, defaultColor: string = '#000000') => ({
  ...
  private dialogConfig: Record<string, any> = {
    ...
    containerColor: this.colorField('containerColor', '#ff0000'),
    progressColor: this.colorField('progressColor', '#ff0000'),
    ...
    iconColorPrimary: this.colorField('iconColorPrimary', '#ff0000'),
    ...
    modal_iconColorStartError: this.colorField('modal_iconColorStartError', '#ff0000'), 
    modal_iconColorStartSuccess: this.colorField('modal_iconColorStartSuccess', '#ff0000'), 
    modal_iconColorEnd: this.colorField('modal_iconColorEnd', '#ff0000'), 
    modal_borderColor: this.colorField('modal_borderColor', '#ff0000'), 
